...
@Component({
  ...
  templateUrl: 'severe_injuries.component.html',
})
export class SevereInjuriesPageComponent {
  text1: string = 'When a survivor suffers a severe injury at a hit location, determine the outcome by rolling 1d10' +
    ' on the corresponding table.';
  text2: string = 'A survivor with 5 bleeding tokens is dead.';
  text3: string = 'Some permanent injuries have limits to how many times they can be recorded. If a survivor suffers' +
