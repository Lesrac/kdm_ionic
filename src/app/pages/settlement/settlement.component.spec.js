...
import { AppMock, ConfigMock, DeepLinkerMock, KDMDataServiceMock, KDMDBServiceMock, KDMObserverServiceMock, KeyValueDiffersMock, ModalControllerMock, ModalMock, NavMock, NavParamsMock, PlatformMock, } from '../../mock/mocks';
...
describe('Settlement Component', () => {
    let settlementPageComponent;
    let fixture;
    let settlement;
    let settlementMilestone;
    ...
    beforeEach(() => {
        ...
        settlement.addLocation(new Location('Dummy Location', 'dummy', new Map(), false));
        settlement.addInnovation(new Innovation('Dummy Innovation', 'dummy', InnovationTag.SCULPURE_CONSEQUENCE, [InnovationTag.FAITH], true));
