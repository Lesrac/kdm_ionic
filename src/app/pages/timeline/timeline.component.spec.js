import { App, Config, DeepLinker, DomController, Form, GestureController, IonicModule, Keyboard, Modal, ModalController, NavController, NavParams, Platform, ViewController, } from 'ionic-angular';
import { AppMock, ConfigMock, DeepLinkerMock, KDMDBServiceMock, ModalControllerMock, ModalMock, NavMock, NavParamsMock, PlatformMock, ViewControllerMock, } from '../../mock/mocks';
...
describe('TimelinePageComponent', () => {
    let timelinePageComponent;
    let fixture;
    let kdmdbServiceMock;
    let settlementTimelinePosition1;
    let settlementTimelinePosition2;
    let settlementTimelinePosition3;
    let settlementTimelinePosition4;
    let settlementTimelinePosition5;
    let modalMock;
    beforeEach(() => {
