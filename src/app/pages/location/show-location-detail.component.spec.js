...
import { App, Config, DeepLinker, DomController, Form, GestureController, IonicModule, Keyboard, NavController, NavParams, Platform, ViewController, } from 'ionic-angular';
...
describe('Show Location Detail', () => {
    let showLocationDetailComponent;
    let fixture;
    let object;
    beforeEach(() => {
        ...
        object = new Location('Dummy Location', 'dummy', new Map(), false);
...
//# sourceMappingURL=show-location-detail.component.spec.js.map