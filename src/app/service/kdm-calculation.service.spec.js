...
import { KDMCalculationService } from './kdm-calculation.service';
...
describe('Service: Calculation', () => {
    ...
    it('addResourcesFromKilledMonster', fakeAsync(inject([KDMCalculationService], (kdmCalculationService) => {
        ...
        const originalMonster = new Monster(1, 'White Lion', false);
        ...
        const huntedMonster = new HuntedMonster(settlement, originalMonster);
...
//# sourceMappingURL=kdm-calculation.service.spec.js.map